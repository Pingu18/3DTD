...
public class TowerUpgrades : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        valueDict.Add("level_1_newSpecial_Dark", 0.75f);    // haven't set up Dark tower special upgrade
        valueDict.Add("level_2_newSpecial_Dark", 1f);
        valueDict.Add("level_3_newSpecial_Dark", 1.25f);

        valueDict.Add("level_1_newSpecial_Light", 0.75f);   // haven't set up Light tower special upgrade
